 ...
 *
 */
public class RollervatorClimbStageOne extends Command {
	
	private double climbSpeed = 0; 
	

	public RollervatorClimbStageOne(double setPoint) {
	...
	protected boolean isFinished() {
		return Robot.rollervator.isExceedingCurrentThreshhold(6.5); // This
																				// is
																				// the
																				// amount
																				// of
