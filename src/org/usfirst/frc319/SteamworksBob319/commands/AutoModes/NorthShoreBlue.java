 ...
 *
 */
public class NorthShoreBlue extends CommandGroup {

// this is for testing
  
    public NorthShoreBlue() {
    	addParallel(new DeployCollectorAfterWait(1.0));
    	addSequential(new FollowTrajectory("NorthShoreBlue"));
    	addSequential(new SmartShoot());
    	addSequential(new FollowTrajectoryAndCollect("NorthShoreBluePt2"));
