 ...
 *
 */
public class FollowTrajectoryAndCollect extends Command {
    ...
    public FollowTrajectoryAndCollect(String trajectoryName) {
    ...
    protected void initialize() {
    	Robot.fuelCollector.fuelCollectorIn(1); //keeps running until end of auto
