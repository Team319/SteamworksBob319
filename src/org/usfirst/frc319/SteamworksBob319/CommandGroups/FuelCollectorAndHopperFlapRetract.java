 ...
 *
 */
public class FuelCollectorAndHopperFlapRetract extends CommandGroup {


  
    public FuelCollectorAndHopperFlapRetract() {

    		addSequential(new HopperFlapRetract());
    		addSequential(new FuelCollectorRetract());
